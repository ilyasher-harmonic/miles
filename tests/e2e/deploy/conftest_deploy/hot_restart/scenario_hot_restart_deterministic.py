...
def _build_script_args(
    ...
    assert_the_freeze_schedule_leaves_a_window_the_run_can_redo(restart_mode)
...
@contextmanager
def _driving_the_take_overs_of(
...
def assert_the_freeze_schedule_leaves_a_window_the_run_can_redo(restart_mode: HotRestartMode) -> None:
